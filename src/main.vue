        ...
        methods: {
            ...
            creartScroll(width) {
                this.$nextTick(() => {
                    ...
                    // };
                    if (!this._escapeListenerScroll) {
                        this.container.addEventListener('scroll', throttle(100, this.judgeTableInView));
                        this._escapeListenerScroll = () => {
                            this.container.removeEventListener('scroll', throttle(100, this.judgeTableInView));
                        };
                    }
                });
            },
            ...
            judgeTableInView() {
                this.$nextTick(() => {
                    let _tableContainer = this.$refs.tableContainer;
                    console.log('_tableContainer.clientHeight', _tableContainer.clientHeight)
                    if (_tableContainer) {
